...
public class ListarTecnicosQueryValidator : AbstractValidator<ListarTecnicosQuery>
{
    public ListarTecnicosQueryValidator()
    {
        RuleFor(x => x.Page)
        ...
        RuleFor(x => x.Filtro)
            .MaximumLength(200).WithMessage("Filtro deve ter no máximo 200 caracteres")
